...
class ConfScreenForestTest(BPT):
    ...
    def _get_pipeline(self):
        ...
        rf_1 = b.RFC(n_estimators=self.n_trees)(X=X, y=y)
        et_1 = b.ETC(n_estimators=self.n_trees)(X=X, y=y)
        ...
        average_3 = self.make_deep_forest_layer(b, X=concat_2, y=filtered_1_y)
