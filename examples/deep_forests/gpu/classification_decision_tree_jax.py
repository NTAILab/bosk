...
def make_deep_forest_functional_gpu(executor, **ex_kw):
    ...
    rf_1 = b.RFCG(n_classes=2)(X=X, y=y)
    et_1 = b.ETCG(n_classes=2)(X=X, y=y)
    concat_1 = b.Concat(['X', 'rf_1', 'et_1'])(X=X, rf_1=rf_1, et_1=et_1)

    rf_2 = b.RFCG(n_classes=2)(X=concat_1, y=y)
    et_2 = b.ETCG(n_classes=2)(X=concat_1, y=y)
    concat_2 = b.Concat(['X', 'rf_2', 'et_2'])(X=X, rf_2=rf_2, et_2=et_2)

    rf_3 = b.RFCG(n_classes=2)(X=concat_2, y=y)
    et_3 = b.ETCG(n_classes=2)(X=concat_2, y=y)
