...
def get_pipelines(n_trees=10, random_state=42):
    ...
    rf_1 = b_1.RFC(random_state=random_state, n_estimators=n_trees)(X=X, y=y)
    et_1 = b_1.ETC(random_state=random_state, n_estimators=n_trees)(X=X, y=y)
    concat_1 = b_1.Concat(['X', 'rf_1', 'et_1'])(X=X, rf_1=rf_1, et_1=et_1)
    rf_2 = b_1.RFC(random_state=random_state, n_estimators=n_trees)(X=concat_1, y=y)
    ...
    rf_1 = b_c.RFC(random_state=random_state, n_estimators=n_trees)(X=X, y=y)
    et_1 = b_c.ETC(random_state=random_state, n_estimators=n_trees)(X=X, y=y)
    concat_1 = b_c.Concat(['X', 'rf_1', 'et_1'])(X=X, rf_1=rf_1, et_1=et_1)
    rf_2 = b_c.RFC(random_state=random_state, n_estimators=n_trees)(X=concat_1, y=y)
    ...
    rf_1 = b_2.RFC(random_state=random_state, n_estimators=n_trees)(X=X, y=y)
    et_1 = b_2.ETC(random_state=random_state, n_estimators=n_trees)(X=X, y=y)
    concat_1 = b_2.Concat(['X', 'rf_1', 'et_1'])(X=X, rf_1=rf_1, et_1=et_1)
    rf_2 = b_2.RFC(random_state=random_state, n_estimators=n_trees)(X=concat_1, y=y)
    ...
    rf_1 = b_3.RFC(random_state=random_state, n_estimators=n_trees)(X=X, y=y)
    et_1 = b_3.ETC(random_state=random_state, n_estimators=n_trees)(X=X, y=y)
    concat_1 = b_3.Concat(['X', 'rf_1', 'et_1'])(X=X, rf_1=rf_1, et_1=et_1)
    rf_2 = b_3.RFC(random_state=random_state, n_estimators=n_trees)(X=concat_1, y=y)
    et_2 = b_3.ETC(random_state=random_state, n_estimators=n_trees)(X=concat_1, y=y)
    concat_2 = b_3.Concat(['rf_2', 'et_2', 'X'])(X=X, rf_2=rf_2, et_2=et_2)
    et_3 = b_3.ETC(random_state=random_state, n_estimators=n_trees)(X=concat_2, y=y)
...
comparator = CVComparator(pipelines, common_part, models, KFold(shuffle=True, n_splits=3))
